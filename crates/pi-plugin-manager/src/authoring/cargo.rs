...
use crate::install::{ReleaseArtifact, ReleaseManifest};
use serde::Deserialize;

use super::bundle::{digest, inspect_library, write_local_manifest};
use super::{
...
pub fn package(options: &PackageOptions) -> Result<PathBuf> {
    ...
    let kind = match descriptor.kind {
        pi_plugin::native::NativePluginKind::Plugin => "plugin",
        pi_plugin::native::NativePluginKind::Provider => "provider",
    };
    ...
    super::bundle::verify(staging.path(), false)?;
