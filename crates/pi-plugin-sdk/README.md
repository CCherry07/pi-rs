...
The current contract is native ABI **21**. ABI 21 adds
...
resolved. The stable C descriptor remains `pi_plugin_descriptor_v1`; ABI 21 constructors use the
`pi_{agent,provider,session}_plugin_create_v21` symbols. Rebuild every native plugin against the
