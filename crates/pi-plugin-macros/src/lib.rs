...
fn expand_export(
    ...
    let (kind_value, trait_type, constructor_name, constructor_alias) = match kind {
        PluginKind::Agent => (
            ...
            Ident::new("pi_agent_plugin_create_v19", proc_macro2::Span::call_site()),
            quote!(::pi_plugin_sdk::AgentPluginCreateV19),
        ),
        PluginKind::Provider => (
            ...
            quote!(::pi_plugin_sdk::ProviderPluginCreateV19),
        ),
        PluginKind::Session => (
            ...
            quote!(::pi_plugin_sdk::SessionPluginCreateV19),
        ),
    };
