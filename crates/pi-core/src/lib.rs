...
pub use plugin::{
    ...
    IsolatedContextMode, IsolatedSessionHandle, IsolatedSessionId, IsolatedSessionOptions,
    IsolatedSessionOutcome, IsolatedSessionRequest, MessageDelivery, MessageEndEvent,
    ...
    SessionEntryView, SessionExecutionOrigin, SessionReplacement, SessionSnapshot, ToolCallBlock,
