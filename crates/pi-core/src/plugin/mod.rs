...
pub use capabilities::{
    ...
    IsolatedContextMode, IsolatedForkPoint, IsolatedSessionHandle, IsolatedSessionId,
    IsolatedSessionOptions, IsolatedSessionOutcome, IsolatedSessionRequest, MessageDelivery,
    ModelsContext, ModelsContextAccess, NavigateTreeOptions, NewSessionOptions, NoticeLevel,
    PluginContext, PluginContextEpoch, PluginContextError, PluginContextHandle,
    PluginContextReplacement, PluginContextResult, PluginContextScope, PresentationMode,
    ReplacedSessionContext, ScopedModel, SendMessageOptions, SendUserMessageOptions,
    SessionContext, SessionContextAccess, SessionEntryKind, SessionEntryView,
    SessionExecutionOrigin, SessionReplacement, SessionSnapshot, UiContext, UiContextAccess,
    UiMultiSelectAction, UiMultiSelectOption, UiMultiSelectRequest, UiMultiSelectResponse,
