...
use pi_plugin_sdk::{
    AgentPluginCreateV19, BUILD_FINGERPRINT, NATIVE_PLUGIN_ABI_VERSION, NativePluginKind,
    PluginDescriptorFnV1, PluginLoadContext, PluginOptionsValue, PluginScope,
    ProviderPluginCreateV19, SessionPluginCreateV19,
};
...
const AGENT_CONSTRUCTOR_SYMBOL: &[u8] = b"pi_agent_plugin_create_v19\0";
const PROVIDER_CONSTRUCTOR_SYMBOL: &[u8] = b"pi_provider_plugin_create_v19\0";
const SESSION_CONSTRUCTOR_SYMBOL: &[u8] = b"pi_session_plugin_create_v19\0";
...
pub struct NativeProviderPluginFactory {
    common: Arc<FactoryCommon>,
    create: ProviderPluginCreateV19,
}
...
fn load_library(
    ...
    match kind {
        NativePluginKind::Agent => {
            ...
            let create = unsafe {
                load_symbol::<AgentPluginCreateV19>(
                    &pinned._library,
                    &package.artifact,
                    AGENT_CONSTRUCTOR_SYMBOL,
                    "pi_agent_plugin_create_v19",
                )?
            };
        ...
        NativePluginKind::Provider => {
            ...
            let create = unsafe {
                load_symbol::<ProviderPluginCreateV19>(
                    &pinned._library,
                    &package.artifact,
                    PROVIDER_CONSTRUCTOR_SYMBOL,
                    "pi_provider_plugin_create_v19",
                )?
            };
        ...
        NativePluginKind::Session => {
            // SAFETY: See the agent constructor branch above.
            let create = unsafe {
                load_symbol::<SessionPluginCreateV19>(
                    &pinned._library,
                    &package.artifact,
                    SESSION_CONSTRUCTOR_SYMBOL,
                    "pi_session_plugin_create_v19",
                )?
            };
