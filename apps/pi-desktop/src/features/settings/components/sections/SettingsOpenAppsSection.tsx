    ...
    >
      <div className="settings-open-apps">
        {openAppDrafts.map((target, index) => {
          ...
          const incompleteHint = !labelValid
            ? t("openApps.validation.label")
            : target.kind === "app"
              ? t("openApps.validation.appName")
              : target.kind === "command"
                ? t("openApps.validation.command")
                : t("openApps.validation.requiredFields");
            ...
            >
              ...
              <div className="settings-open-app-fields">
                <label className="settings-open-app-field settings-open-app-field--label">
                  <span className="settings-visually-hidden">{t("openApps.fields.label")}</span>
                  <input
                    className="settings-input settings-input--compact settings-open-app-input settings-open-app-input--label"
                    value={target.label}
                    placeholder={t("openApps.fields.label")}
                    onChange={(event) =>
                    ...
                    aria-label={t("openApps.fields.labelNumber", { number: index + 1 })}
                    data-invalid={!labelValid || undefined}
                  />
                </label>
                <label className="settings-open-app-field settings-open-app-field--type">
                  <span className="settings-visually-hidden">{t("openApps.fields.type")}</span>
                  <select
                    ...
                    aria-label={t("openApps.fields.typeNumber", { number: index + 1 })}
                  >
                    <option value="app">{t("openApps.types.app")}</option>
                    <option value="command">{t("openApps.types.command")}</option>
                    <option value="finder">{fileManagerName()}</option>
                  </select>
                </label>
                {target.kind === "app" && (
                  <label className="settings-open-app-field settings-open-app-field--appname">
                    <span className="settings-visually-hidden">{t("openApps.fields.appName")}</span>
                    <input
                      ...
                      placeholder={t("openApps.fields.appName")}
                      onChange={(event) =>
                        onOpenAppDraftChange(index, {
                      ...
                      onBlur={onCommitOpenApps}
                      aria-label={t("openApps.fields.appNameNumber", { number: index + 1 })}
                ...
                {target.kind === "command" && (
                  <label className="settings-open-app-field settings-open-app-field--command">
                    <span className="settings-visually-hidden">{t("openApps.fields.command")}</span>
                    <input
                      ...
                      placeholder={t("openApps.fields.command")}
                      onChange={(event) =>
                        onOpenAppDraftChange(index, {
                      ...
                      onBlur={onCommitOpenApps}
                      aria-label={t("openApps.fields.commandNumber", { number: index + 1 })}
                ...
                {target.kind !== "finder" && (
                  <label className="settings-open-app-field settings-open-app-field--args">
                    <span className="settings-visually-hidden">{t("openApps.fields.args")}</span>
                    <input
                      ...
                      placeholder={t("openApps.fields.args")}
                      onChange={(event) =>
                        onOpenAppDraftChange(index, {
                      ...
                      onBlur={onCommitOpenApps}
                      aria-label={t("openApps.fields.argsNumber", { number: index + 1 })}
                    />
                  </label>
                )}
              </div>
              <div className="settings-open-app-actions">
                ...
                <div className="settings-open-app-order">
                  <button
                    ...
                    disabled={index === 0}
                    aria-label={tCommon("actions.moveUp")}
                  >
                  ...
                  <button
                    ...
                    aria-label={tCommon("actions.moveDown")}
                  >
                ...
                <button
                  ...
                  aria-label={t("openApps.remove")}
                  title={t("openApps.remove")}
                >
                  <Trash2 aria-hidden />
                </button>
              </div>
      ...
      <div className="settings-open-app-footer">
        ...
        <div className="settings-help">
          {t("openApps.commandPathHelp")} {" "}
          {isMacPlatform()
            ? t("openApps.macHelp")
            : t("openApps.otherHelp")}
        </div>
      </div>
    </SettingsSection>
  );
