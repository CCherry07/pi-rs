...
export const MainHeaderActions = memo(function MainHeaderActions({
  ...
  return (
    <>
      {centerMode === "diff" && (
        <div className="diff-view-toggle" role="group" aria-label={t("diffView.aria")}>
          <button
            type="button"
          ...
          <button
            ...
            title={t("diffView.unified")}
            data-tooltip={t("diffView.unified")}
            data-tooltip-placement="bottom"
            data-tauri-drag-region="false"
          >
