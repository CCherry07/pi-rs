...
export function MainHeader({
  ...
  const branchValidationMessages = useMemo(
    () => ({
  ...
  const branchValidationMessage = useMemo(
    () => validateBranchName(trimmedQuery, branchValidationMessages),
    [branchValidationMessages, trimmedQuery],
  );
          ...
          {disableBranchMenu ? (
            <div className="workspace-branch-static-row" ref={infoRef}>
              <MenuTrigger
                ...
                title={t("app:header.worktreeInfo")}
              >
                ...
                <PopoverSurface className="worktree-info-popover" role="dialog">
                  {worktreeRename && (
                    <div className="worktree-info-rename">
                      <span className="worktree-info-label">{t("app:header.name")}</span>
                      <div className="worktree-info-command">
                        ...
                        <button
                          ...
                          aria-label={t("app:header.confirmRename")}
                          title={t("app:header.confirmRename")}
                        >
                          <Check aria-hidden />
                        </button>
                      </div>
                      ...
                      {worktreeRename.upstream && (
                        <div className="worktree-info-upstream">
                          <span className="worktree-info-subtle">
                            {t("app:header.updateUpstreamQuestion", {
                  ...
                  <div className="worktree-info-title">{t("app:header.worktree")}</div>
                  <div className="worktree-info-row">
                    <span className="worktree-info-label">
                      {t("app:header.terminal")}
                      {parentPath ? ` (${t("app:header.repoRoot")})` : ""}
                    </span>
                    <div className="worktree-info-command">
                      ...
                      <button
                        ...
                        data-tauri-drag-region="false"
                        aria-label={t("app:header.copyCommand")}
                        title={t("app:header.copyCommand")}
                      >
                        <Copy aria-hidden />
                      </button>
                    </div>
                    <span className="worktree-info-subtle">
                      {t("app:header.terminalHelp")}
                    </span>
                  </div>
                  <div className="worktree-info-row">
                    <span className="worktree-info-label">{t("app:header.reveal")}</span>
                    <button
                      type="button"
                      ...
                      data-tauri-drag-region="false"
                    >
                      {t("app:header.revealIn", { fileManager: fileManagerName() })}
                    </button>
                  </div>
                </PopoverSurface>
              )}
                  ...
                  <div className="branch-actions">
                    <div className="branch-search">
                      <input
                        ...
                        placeholder={t("app:header.searchBranch")}
                        ...
                        autoFocus
                        data-tauri-drag-region="false"
                        aria-label={t("app:header.searchBranches")}
                      />
                      <button
                        type="button"
                    ...
                    {canCreate && !branchValidationMessage && (
                      <div className="branch-create-hint">
                        {t("app:header.createBranch", { branch: trimmedQuery })}
                      </div>
                    )}
                  </div>
                  <BranchList
                    ...
                    emptyText={t("app:header.noBranches")}
      ...
      <div className="main-header-actions">
        ...
        {showTerminalButton && (
          <button
            ...
            data-tauri-drag-region="false"
            aria-label={t("app:header.toggleTerminal")}
            title={t("app:header.terminal")}
            data-tooltip={t("app:header.terminal")}
        ...
        <button
          ...
          data-tauri-drag-region="false"
          aria-label={t("app:header.copyThread")}
          title={t("app:header.copyThread")}
          data-tooltip={t("app:header.copyThread")}
          data-tooltip-placement="bottom"
        >
