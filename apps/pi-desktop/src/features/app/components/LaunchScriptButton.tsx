    ...
    <div className="launch-script-menu" ref={popoverRef}>
      <div className="launch-script-buttons">
        <button
          ...
          aria-label={hasLaunchScript ? t("app:launch.run") : t("app:launch.set")}
          title={hasLaunchScript ? t("app:launch.run") : t("app:launch.set")}
          data-tooltip={hasLaunchScript ? t("app:launch.run") : t("app:launch.set")}
      ...
      {editorOpen && (
        <PopoverSurface className="launch-script-popover" role="dialog">
          <div className="launch-script-title">{t("app:launch.title")}</div>
          <textarea
            className="launch-script-textarea"
            placeholder={t("app:launch.placeholder")}
            value={draftScript}
          ...
          {showNew && newEditorOpen && onNewDraftChange && onNewDraftIconChange && onCreateNew && (
            <div className="launch-script-new">
              <div className="launch-script-title">{t("app:launch.newTitle")}</div>
              ...
              <input
                ...
                type="text"
                placeholder={t("app:launch.optionalLabel")}
                value={newDraftLabel}
              ...
              <div className="launch-script-actions">
                ...
                <button
                  ...
                  data-tauri-drag-region="false"
                >
                  {isSaving ? t("common:saving") : t("common:actions.create")}
                </button>
              </div>
            </div>
          )}
