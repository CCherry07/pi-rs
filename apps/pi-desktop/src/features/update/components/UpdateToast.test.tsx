...
describe("UpdateToast", () => {
  ...
  it("renders downloading state with progress", () => {
    ...
    expect(screen.getByText("500 B / 1,000 B")).toBeTruthy();
    ...
    const { container } = render(
      <UpdateToast
        ...
        postUpdateNotice={{
          stage: "loading",
          version: "1.2.3",
          htmlUrl: "https://github.com/CCherry07/pi-rs/releases/tag/v1.2.3",
        }}
  ...
  it("renders post-update release notes and opens GitHub link", () => {
    const onDismissPostUpdateNotice = vi.fn();
    const htmlUrl =
      "https://github.com/CCherry07/pi-rs/releases/tag/v1.2.3";
    const state: UpdateState = { stage: "idle" };
