...
export function FileTreePanel({
  ...
  const selectionHints = useMemo(
    () =>
      previewKind === "text"
        ? [t("files.selectionHintGesture"), t("files.selectionHintPurpose")]
        : [],
    [previewKind, t],
  );
          ...
          <div className="file-tree-count">
            {visibleEntries.length
              ...
              : showLoading
                ? t("files.loadingList")
                : filterMode === "modified"
                  ? t("files.noModifiedShort")
                  : t("files.noFilesShort")}
          </div>
          {hasFolders ? (
            <button
              type="button"
              ...
              aria-label={allVisibleExpanded ? t("files.collapseAll") : t("files.expandAll")}
              title={allVisibleExpanded ? t("files.collapseAll") : t("files.expandAll")}
            >
        ...
        <PanelSearchField
          ...
          trailing={
            <button
              ...
              aria-label={
                filterMode === "modified" ? t("files.showAll") : t("files.showModified")
              }
              title={filterMode === "modified" ? t("files.showAll") : t("files.showModified")}
            >
      ...
      >
        {showLoading ? (
          ...
          <div className="file-tree-empty">
            {normalizedQuery
              ? filterMode === "modified"
                ? t("files.noModifiedMatches")
                : t("files.noMatches")
              : filterMode === "modified"
                ? t("files.noModified")
                : t("files.noneAvailable")}
          </div>
        ) : (
          <div
