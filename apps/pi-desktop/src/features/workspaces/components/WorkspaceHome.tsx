...
export function WorkspaceHome({
  ...
  const agentMdStatus = agentMdLoading
    ...
    : agentMdSaving
      ? t("workspaces:home.saving")
      : agentMdExists
        ? ""
        : t("workspaces:home.notFound");
  const agentMdMetaParts: string[] = [];
  if (agentMdStatus) {
    agentMdMetaParts.push(agentMdStatus);
  }
  if (agentMdTruncated) {
    agentMdMetaParts.push(t("workspaces:home.truncated"));
  }
    ...
    <div className="workspace-home">
      ...
      <div className="workspace-home-composer">
        <div className="composer">
          <ComposerInput
            text={prompt}
            disabled={isSubmitting}
            sendLabel={t("workspaces:home.send")}
            canStop={false}
      ...
      <div className="workspace-home-agent">
        ...
        <FileEditorCard
          ...
          placeholder={t("workspaces:home.agentPlaceholder")}
