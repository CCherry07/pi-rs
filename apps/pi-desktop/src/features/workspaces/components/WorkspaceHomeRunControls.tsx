...
export function WorkspaceHomeRunControls({
  ...
  const runModeLabel = runMode === "local"
    ? t("workspaces:home.modeLocal")
    : t("workspaces:home.modeWorktree");
        ...
        <SplitActionMenu
          ...
          actionButton={
            <button
              ...
              aria-label={t("workspaces:home.selectRunMode")}
          ...
          toggleAriaLabel={t("workspaces:home.toggleRunMode")}
      ...
      <SplitActionMenu
        ...
        actionButton={
          <button
            ...
            aria-label={t("workspaces:home.selectModels")}
            data-tauri-drag-region="false"
          >
            <span className="open-app-label">
        ...
        toggleClassName="ghost open-app-toggle"
        toggleAriaLabel={t("workspaces:home.toggleModels")}
        toggleIcon={<ChevronDown size={14} aria-hidden />}
      ...
      >
        {models.length === 0 && (
          <div className="workspace-home-empty">
            {t("workspaces:home.connectModels")}
          </div>
        )}
        {models.map((model) => {
          const isSelected =
      ...
      <div className="composer-select-wrap workspace-home-control">
        <div className="open-app-button">
          ...
          <select
            ...
            aria-label={t("workspaces:home.thinkingMode")}
          ...
          >
            ...
            {reasoningOptions.map((effortOption) => (
              <option key={effortOption} value={effortOption}>
                {t(`common:reasoning.${effortOption}` as "common:reasoning.low", {
                  defaultValue: effortOption,
                })}
              </option>
            ))}
          </select>
