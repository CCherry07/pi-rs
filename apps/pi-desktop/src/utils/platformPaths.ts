...
export function fileManagerName(): string {
  ...
  return i18n.t("fileManager.generic", { ns: "common" });
}

export function revealInFileManagerLabel(): string {
  const platform = platformKind();
  if (platform === "mac") {
    return i18n.t("fileManager.revealIn", { ns: "common", name: "Finder" });
  }
  if (platform === "windows") {
    return i18n.t("fileManager.showIn", { ns: "common", name: "Explorer" });
  }
  return i18n.t("fileManager.revealIn", {
    ns: "common",
...
export function openInFileManagerLabel(): string {
  return i18n.t("fileManager.openIn", {
    ns: "common",
    name: fileManagerName(),
  });
}
