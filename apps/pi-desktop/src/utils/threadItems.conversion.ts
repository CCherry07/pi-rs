...
export function buildConversationItem(
  ...
  if (type === "plan") {
    return {
      ...
      kind: "tool",
      toolType: "plan",
      title: i18n.t("messages:tool.plan"),
  ...
  if (type === "commandExecution") {
    ...
    return {
      ...
      toolType: type,
      title: command
        ? i18n.t("messages:tool.commandNamed", { command })
        : i18n.t("messages:tool.command"),
  ...
  if (type === "fileChange") {
    ...
    return {
      ...
      kind: "tool",
      toolType: type,
      title: i18n.t("messages:tool.fileChanges"),
      detail: paths || i18n.t("messages:tool.pendingChanges"),
      status: asString(item.status ?? ""),
      output: diffOutput,
  ...
  if (type === "mcpToolCall") {
    ...
    return {
      ...
      kind: "tool",
      toolType: type,
      title: i18n.t("messages:tool.tool", {
        name: `${server}${tool ? ` / ${tool}` : ""}`,
      }),
      detail: args,
      status: asString(item.status ?? ""),
  ...
  if (type === "webSearch") {
    ...
    return {
      ...
      kind: "tool",
      toolType: type,
      title: i18n.t("messages:tool.webSearch"),
  ...
  if (type === "imageView") {
    return {
      ...
      kind: "tool",
      toolType: type,
      title: i18n.t("messages:tool.imageView"),
  ...
  if (type === "contextCompaction") {
    ...
    return {
      ...
      kind: "tool",
      toolType: type,
      title: i18n.t("messages:tool.contextCompaction"),
      detail: i18n.t("messages:tool.compacting"),
      status: status || "completed",
      output: "",
    };
  }
