...
use crate::types::{WorkspaceEntry, WorkspaceInfo, WorkspaceKind, WorkspaceSettings};
use crate::utils::normalize_windows_namespace_path;

use super::helpers::{normalize_setup_script, workspace_path_to_string};

pub(crate) async fn add_clone_core(
...
pub(crate) async fn add_workspace_from_git_url_core(
    url: String,
...
pub(crate) async fn update_workspace_settings_core<FApplySettings>(
    id: String,
