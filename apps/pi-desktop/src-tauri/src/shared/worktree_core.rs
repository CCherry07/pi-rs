...
pub(crate) fn unique_worktree_path_best_effort(base_dir: &Path, name: &str) -> PathBuf {
...
pub(crate) fn build_clone_destination_path(copies_folder: &Path, copy_name: &str) -> PathBuf {
