...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            workspaces::create_workspace_project,
            workspaces::add_workspace,
            workspaces::add_workspace_from_git_url,
            workspaces::add_clone,
            workspaces::add_worktree,
            workspaces::prepare_worktree_plan,
            workspaces::create_worktree_plan,
            workspaces::discard_worktree_plan,
            workspaces::list_managed_worktrees,
            workspaces::get_worktree_delivery,
            workspaces::preview_worktree_delivery,
            workspaces::execute_worktree_delivery,
            workspaces::inspect_worktree_delivery_attempt,
            workspaces::finish_worktree_delivery_attempt,
            ...
            pi_runtime::skills::pi_skill_library_list,
            pi_runtime::skills::pi_skill_library_operation,
            pi_runtime::mcp::pi_mcp_read,
            pi_runtime::mcp::pi_mcp_save,
            pi_runtime::mcp::pi_mcp_test,
            pi_runtime::plugins::pi_plugins_read,
            pi_runtime::plugins::pi_plugins_operation,
            pi_runtime::plugins::pi_plugins_runtime,
