...
use super::highlight::{self, TokenClass};
use super::parser::{self, AlertKind, Block, InlineRun, InlineStyle, ListItem, TableAlign};
...
pub fn render(source: &str, streaming: bool, theme: MarkdownTheme) -> RenderedMarkdown {
    ...
    let mended = streaming
        .then(|| super::mend::close_hanging(source))
        .flatten();
